...
def unique_houses(filename):
    ...
    # for each line in file
        # split string by ('|'), convert to list of strings
        # use index to find house 
        # add to list of houses
         
    # # convert list of houses to new set with house names

    # student_houses = []
    # for line in cohort_data:
    #     student_data = line.split('|')
    #     if student_data[2] != "":
    #         student_houses.append(student_data[2])
    
    # houses = set(student_houses)
    # return houses

    students = [line.split('|') for line in cohort_data]
    student_houses = [student[2] for student in students if student[2] != ""]
